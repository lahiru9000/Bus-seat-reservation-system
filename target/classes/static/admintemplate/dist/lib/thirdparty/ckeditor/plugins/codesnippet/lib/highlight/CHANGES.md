...
appUsers won't be affected by the latter: the basic scenario described in the
...
- Language detection can now be restricted to a subset of languages relevant in
  ...
  Another example is a StackOverflow-style site where appUsers specify languages
...
if you find there some fancy Cyrillic letters -- it's for Russian appUsers too :-)
