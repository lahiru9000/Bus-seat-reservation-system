...
<div class="container">
    <h2>Add Bus</h2>
    <br>
    <form action='/bus/save' method='post'>
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                ...
                <td><input type='number' name='seatCount' class='form-control' required/></td>
            </tr>
            <tr>
                <td><b>Bus Type</b></td>
                <td>
                ...
                <td>
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label" for="seats">
                            <input type="checkbox" class="form-check-input" id="seats" name="facilities"
