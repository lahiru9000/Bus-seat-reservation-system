...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    ...
    <ul class="navbar-nav">
        <li class="nav-item active">
            <a class="nav-link" href="/appUser/all">All Passengers</a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="/appUser/add">Add New Passenger</a>
        </li>
    </ul>
</nav>
...
<div class="container">
    ...
    <form action='/appUser/update' method='post'>
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                <td><b>User Name</b></td>
                <td><input type='text' name='username' class='form-control' value="${appUser.username}" required/></td>
            </tr>
            <tr>
                <td><b>Password</b></td>
                <td><input type='password' name='password' class='form-control' value="${appUser.password}" required/></td>
            </tr>
            <tr>
                <td><b>Gender</b></td>
