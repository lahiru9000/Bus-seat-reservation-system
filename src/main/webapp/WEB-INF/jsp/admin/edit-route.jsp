                                        ...
                                        <div class="col-md-6">
                                            <fieldset class="content-group margin-top-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <form:select id="dropdown" cssClass="form-control" path="route.startLocation">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <form:select id="dropdown" cssClass="form-control" path="route.endLocation">
                                                        <form:options items="${locations}"/>
                                                    </form:select>
                                                </div>
