                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-block">
                                <form action="/admin/trip/update" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="content-group margin-top-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label">Register Number of Bus</label>
                                                    <br>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name='pricePerSeat' class="form-control"
                                                           value="${trip.pricePerSeat}" required>
                                                </div>
                                                ...
                                                <div class="content-group-lg">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                        <input type="text" class="form-control pickadate-labels"
                                                               placeholder="Try me.." name="arrivalDate"
                                                               value="${trip.arrivalDate}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="content-group-lg margin-top-20">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control timepicker"
                                                               ...
                                                               value="${trip.departureTime}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="content-group-lg margin-top-20">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="fa fa-calendar"></i></span>
                                                        <input type="text" class="form-control timepicker"
                                                               placeholder="Try me.." name="arrivalTime"
                                                               value="${trip.arrivalTime}" required>
                                                    </div>
                                                </div>
