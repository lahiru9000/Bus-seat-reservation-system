...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/seatstemplate/css/jquery.seat-charts.css">
    <link href="${pageContext.request.contextPath}/seatstemplate/css/style.css" rel="stylesheet" type="text/css"
          media="all"/>
    ...
    <div class="main">
        ...
        <div class="wrapper">
            ...
            <div class="booking-details">
                ...
                <a href="${pageContext.request.contextPath}/payment" id="payment">
